...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        if (view.isMultiDayRange(componentFootprint.unzonedRange)) {
            ...
            // Display the normal time text for the *event's* times - soumen
        ...
        return '<a class="' + classes.join(' ') + '"' +
            ...
            (timeText ?
                '<div class="fc-time"' +
                    ...
                    '>' +
                    '<span id="timetext">' + util_1.htmlEscape(timeText) +' '+ '</span>' +
                    '</div>' :
                '') +
            '</div>' +
            '<div class="fc-bg"/>' +
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        return '<a class="' + classes.join(' ') + '"' +
            ...
            (this.dayGrid.isRTL ?
                ...
                timeHtml + ' ' +  titleHtml //
                //timeHtml + ' ' + titleHtml // soumen to change time & title sequence
            ) +
            '</div>' +
            (isResizableFromStart ?
                '<div class="fc-resizer fc-start-resizer" />' :
...
ViewRegistry_1.defineView('CurrentListView', {
    type: 'list',
    duration: { days: 2 },
    defaults: {
        listDayAltFormat: 'dddd' // day-of-week is nice-to-have
