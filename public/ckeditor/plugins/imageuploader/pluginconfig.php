...
$username = "devmaster"; $password = 'd54d1702ad0f8326224b817c796763c9';

    $useruploadfolder = "teamvg/images";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "teamvg/images";
    ...
    $useruploadfolder = "teamvg/home_images";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "teamvg/home_images";
    ...
    $useruploadfolder = "teamvg/temp/";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "teamvg/temp/";
    ...
    $useruploadfolder = "teamvgdev/home_images/";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "teamvgdev/home_images/";
