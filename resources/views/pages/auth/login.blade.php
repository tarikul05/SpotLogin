    ...
    <div class="container-fluid">
        <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-6 col-6 sportlogin-feature">
                ...
                <p class="gilroy-light txtdarkblue">Communicate with the parents within the app<br><h4 class="gilroy-bold">Cooming Soon</h4></p>
            ...
            <div class="col-lg-3 col-md-6 col-6 sportlogin-feature">
                ...
                <p class="gilroy-light txtdarkblue">Allow your students to pay online in a click<h4 class="gilroy-bold">Cooming Soon</h4></p>
            </div>
        </div>
    </div>
  </section>
    ...
    <div class="container-fluid p-0" style="max-width: 100%;">
        <div class="row no-gutters">
            <div class="col-lg-6 col-md-12 order-1 order-lg-2">
                <div class="about-us-cont-bg"
                    style="background: url({{ asset('img/nguyen-thu-hoai-v0H-vn0BixI-un@2x.png') }}); background-size: cover;background-position: center;">
                    <h1 class="mb-0 gilroy-bold text-white"><img src="{{ asset('img/SPORT-LOGIN-logo.png') }}"
                            width="78">Sportlogin</h1>
                </div>
            </div>
    ...
    <div class="container-fluid p-0" style="max-width: 100%;">
        <div class="row no-gutters">
            <div class="col-lg-6 col-md-12">
                <div class="software-capabilities-cont-bg"
                    style="background: url({{ asset('img/amelia-bartlett-OgT83CPGbQI-un_fi@2x.png') }}); background-size: cover;background-position: center;">
                </div>
            </div>
