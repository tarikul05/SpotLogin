        ...
        <div class="logo_area">
            ...
            <div class="right_part">
                <div class="invoice_date">
                    ...
                    <div class="padding_top"><span class="txt">{{ __('due_date_of_invocie') }}</span><span class="date">{{ $invoice->date_due ? {{ Carbon\Carbon::parse($invoice_data->date_due)->format('d.m.Y')}} : Carbon\Carbon::parse($invoice_data->date_invoice)->addDays(7)->format('d.m.Y')}}</span></div>
                </div>
            </div>
        </div>
    </header>
