...
<script>
    (function() {
      ...
      var countryCodeApplePay = "{{$AppUI->selectedSchoolCountryCode()}}";
        ...
        if (result) {
          ...
          paymentRequest.on('paymentmethod', async (event) => {
            ...
            const response = await fetch(BASE_URL + '/payment/invoice', {
              ...
              body: JSON.stringify({stripe_payment_method_id:event.paymentMethod.id,invoice_id:theInvoiceIdApplePay}),
            });
