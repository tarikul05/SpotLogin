									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<div class="input-group" id="sprice_amount_buy_div">
												...
												<input id="sprice_amount_buy" placeholder="0" name="sprice_amount_buy" type="text" class="form-control" value="{{!empty($eventData->buy_total) ? old('price_amount_buy', $eventData->buy_total) : old('buy_total')}}" autocomplete="off">
