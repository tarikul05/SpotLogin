...
<form enctype="multipart/form-data" class="form-horizontal" id="add_student" method="post" action="{{ route('student.createAction') }}"  name="add_student" role="form">
    @csrf
        ...
        <div class="card">
            <div class="card-header h6">{{ __('Add New Student') }}</div>
                <div class="card-body">
        ...
        <div class="card mt-4">
            <div class="card-header h6">{{__('Student informations')}}</div>
            <div class="card-body">

							<div class="row">
								<div class="col-md-6 col-xs-12">
									<div class="form-group ">
										<label class="text-left" for="level_id"><b>{{__('Level') }}</b></label>
									...
									<div class="form-group ">
									<label class="text-left"><b>{{__('Date last level ASP') }}</b></label>
											<div class="input-group">
									...
									@if($AppUI->isTeacherAdmin() || $AppUI->isTeacherSchoolAdmin() || $AppUI->isSchoolAdmin() || $AppUI->isTeacherAll())
										<div class="form-group pt-3">
											<label class="text-left"><b>{{__('Private comment') }}</b></label>
								...
								<div class="col-md-6 col-xs-12">
									<div class="form-group ">
										<label class="text-left" for="licence_usp" id="locality_caption"><b>{{__('License number') }}</b></label>
									...
									<div class="form-group ">
									<label class="text-left"><b>{{__('Date last level USP') }}</b></label>
		...
		<div class="card mt-4">
            <div class="card-header h6">Student Address</div>
            <div class="card-body">
					...
					<div class="row">
						<div class="col-md-6 col-xs-12">
							<div class="form-group ">
								<label class="text-left" for="street" id="street_caption"><b>{{__('Street') }}</b></label>
							...
							<div class="form-group ">
								<label class="text-left" for="street_number" id="street_number_caption"><b>{{__('Street No') }}</b></label>
							...
							<div class="form-group ">
								<label class="text-left" for="zip_code" id="postal_code_caption"><b>{{__('Postal Code') }}</b></label>
						...
						<div class="col-md-6 col-xs-12">
							<div class="form-group ">
								<label class="text-left" for="place" id="locality_caption"><b>{{__('City') }}</b></label>
							...
							<div class="form-group ">
								<label class="text-left" for="country_code" id="pays_caption"><b>{{__('Country') }}</b></label>
							...
							<div class="form-group row" id="province_id_div" style="display: none;">
								<label class="text-left" for="province_id" id="pays_caption"><b>{{__('Province') }}</b></label>
					...
					<div class="row">
						<div class="col-md-6 col-xs-12">
							<div class="form-group">
							<label class="text-left" for="billing_street" id="street_caption"><b>{{__('Street') }}</b></label>
								<div class="input-group">
							...
							<div class="form-group">
							<label class="text-left" for="billing_street_number" id="street_number_caption"><b>{{__('Street No') }}</b></label>
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
							...
							<div class="form-group">
							<label class="text-left" for="billing_zip_code" id="postal_code_caption"><b>{{__('Postal Code') }}</b></label>
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
						...
						<div class="col-md-6 col-xs-12">
							<div class="form-group">
							<label class="text-left" for="billing_place" id="locality_caption"><b>{{__('City') }}</b></label>
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
							...
							<div class="form-group">
							<label class="text-left" for="billing_country_code" id="pays_caption"><b>{{__('Country') }}</b></label>
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
			...
			<div class="card mt-4">
				<div class="card-header h6">{{__('Contact Information') }}</div>
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-6 col-xs-12">
							<div class="form-group">
						<label class="text-left" for="father_phone" id="father_phone"><b>{{__("Father's phone") }}</b></label>
							...
							<div class="form-group">
							<label class="text-left" for="mother_phone" id="mother_phone"><b>{{__("Mother's phone") }}</b></label>
							...
							<div class="form-group">
								<label class="text-left" for="student_phone" id="student_phone"><b>{{__("Student's phone") }}</b></label>
						...
						<div class="col-md-6 col-xs-12">
							<div class="form-group">
								<label class="text-left" for="father_email" id="father_email"><b>{{__("Father’s email") }}</b></label>
							...
							<div class="form-group">
								<label class="text-left" for="mother_email"><b>{{__("Mother’s email") }}</b></label>
							...
							<div class="form-group">
								<label class="text-left" for="email2" ><b>{{__("Student's email") }}</b></label>
