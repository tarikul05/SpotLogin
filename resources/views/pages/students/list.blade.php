...
<script type="text/javascript">
    $(document).ready( function () {
        $('#example').DataTable();
        @can('students-create')
        $("#example_filter").append('<a class="btn btn-theme-success add_teacher_btn" href="{{ auth()->user()->isSuperAdmin() ? route('admin.students.create',['school'=> $schoolId]) : route('students.create') }}">Add a professor</a>')
        @endcan
    } );
</script>
@endsection