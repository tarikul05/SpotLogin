                          ...
                          <div id="collapse-{{ $key }}" class="accordion-collapse collapse" aria-labelledby="heading-{{ $key }}" data-bs-parent="#accordionExample" data-category-id="{{ $category->title }}" style="background-color: rgba(202, 197, 197, 0.03);">
                            ...
                            @endif
                                ...
                                <?php if($number_of_coaches > 0 && ($AppUI->isSchoolAdmin() || $AppUI->isTeacherSchoolAdmin())) { ?>
                                    ...
                                    <div class="text-center p-1 pb-3" style="font-size:16px;color:#0075bf;">
                                        <i class="fa fa-arrow-down"></i><br>
                                        Setup this category to the {{ $number_of_coaches }} {{ $number_of_coaches > 1 ? 'teachers':'teacher' }} settings
                                    </div>
                                    @foreach ($teachers as $key2 => $teacher)
                                    <table id="tariff_table_rate" class="table table-bordered table-hover" style="font-size:13px; max-width:750px; margin:0 auto; border-radius: 10px; padding: 10px; margin-bottom:15px;">
                                        <thead>
                                            <tr>
