...
<br><b style="color:#0075bf; font-size:22px;">Dear {{ $paymentData['coach_name'] }},</b><br><br>
</div>
<h2>Payment Received</h2>
<p>Dear {{ $paymentData['coach_name'] }},</p>

<p>You have received a payment from {{ $paymentData['student_name'] }}:</p>

<ul>
<li>Amount: {{ $paymentData['amount'] }} {{ $paymentData['currency'] }}</li>
<li>Invoice Number: {{ $paymentData['invoice_id'] }}</li>
<li>Student: {{ $paymentData['student_name'] }}</li>
